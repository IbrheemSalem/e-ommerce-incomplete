...
@section('content')
    <h1 class="p-relative"><i class="fa-solid fa-right-long mt-1"></i> Create Categories</h1>
    <div class="container">
    ...
    <div class="container w-75">
        <form class="row g-3" action="{{ route('admin.main_catgeries.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
